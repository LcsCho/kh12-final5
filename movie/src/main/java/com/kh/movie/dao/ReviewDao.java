...
public interface ReviewDao {
	...
	List<ReviewListVO> findByDateDesc(PaginationVO paginationVO, int movieNo);//최신순
	List<ReviewListVO> findByDateAsc(PaginationVO paginationVO, int movieNo);//오래된순
	List<ReviewListVO> findByLikeDesc(PaginationVO paginationVO, int movieNo);//좋아요순
	List<ReviewListVO> findByRatingDesc(PaginationVO paginationVO, int movieNo);//평점높은순
	List<ReviewListVO> findByRatingAsc(PaginationVO paginationVO, int movieNo);//평점낮은순

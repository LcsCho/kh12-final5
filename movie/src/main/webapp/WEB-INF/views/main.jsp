    ...
    <div class="row">
                        ...
                        <div class="swiper-slide">
                            <div class="col-sm-6 col-md-4 col-lg-3" style="width:250px;">
                                <a href="/movie/detail?movieNo=${mvcTop10RecommendVO.movieNo}">
                                    <img src="/image/${mvcTop10RecommendVO.imageNo}" class="img-thumbnail"
                    ...
                    <c:forEach var="mvcCriticTop10RecommendVO" items="${mvcCriticTop10RecommendList}">
                        <div class="swiper-slide">
                            <div class="col-sm-6 col-md-4 col-lg-3" style="width:250px;">
                                ...
                                <div class="col">
                                    <a href="/movie/detail?movieNo=${mvcCriticTop10RecommendVO.movieNo}">
                                        ${mvcCriticTop10RecommendVO.movieName}
                                    </a>
                                </div>
                                <div class="col">
                                    <fmt:formatDate value="${mvcCriticTop10RecommendVO.movieReleaseDate}"
                                        pattern="yyyy" />
                                    /
        ...
        <div class="swiper-button-next custom-next"></div>
            ...
            <c:if test="${sessionScope.name != null}">
                                ...
                                <div class="swiper-slide">
                                    <div class="col-sm-6 col-md-4 col-lg-3" style="width:250px;">
                                        ...
                                        <div class="col">
                                            <a
                                                href="/movie/detail?movieNo=${preferGenreByMemberRecommendVO.movieNo}">
                                                ${preferGenreByMemberRecommendVO.movieName}
                                            </a>
                                        </div>
                                        <div class="col">
                                            <fmt:formatDate
                ...
                <div class="swiper row">
                    <div class="swiper-wrapper">
                        <c:forEach var="ageGroupRecommendVO" items="${ageGroupRecommendList}">
                            <div class="swiper-slide">
                                <div class="col-sm-6 col-md-4 col-lg-3" style="width:250px;">
                                    <div>
                    ...
                    <div class="col">
                        <c:choose>
                            <c:when test="${ageGroup < 10}">
                                <c:choose>
                                    <c:when test="${memberGender == '남자'}">
                                        <h3>10살 미만의 남성을 위한 영화를 추천드려요!
                                        </h3>
                                    </c:when>
                                    <c:otherwise>
                                        <h3>10살 미만의 여성을 위한 영화를 추천드려요!
                                        </h3>
                                    </c:otherwise>
                                </c:choose>
                            </c:when>
                            <c:when test="${ageGroup >= 60}">
                                <c:choose>
                                    <c:when test="${memberGender == '남자'}">
                                        <h3>60대 이상의 남성을 위한 영화를 추천드려요!
                                        </h3>
                                    </c:when>
                                    <c:otherwise>
                                        <h3>60대 이상의 여성을 위한 영화를 추천드려요!
                                        </h3>
                                    </c:otherwise>
                                </c:choose>
                            </c:when>
                            <c:otherwise>
                                <c:choose>
                                    <c:when test="${memberGender == '남자'}">
                                        <h3>${ageGroup}대남성을위한영화를추천드려요!
                                        </h3>
                                    </c:when>
                                    <c:otherwise>
                                        <h3>${ageGroup}대여성을위한영화를추천드려요!
                                        </h3>
                                    </c:otherwise>
                                </c:choose>
                            </c:otherwise>
                ...
                <div class="swiper row">
                    <div class="swiper-wrapper">
                        <c:forEach var="ageGroupGenderRecommendVO" items="${ageGroupGenderRecommendList}">
                            <div class="swiper-slide">
                                <div class="col-sm-6 col-md-4 col-lg-3" style="width:250px;">
                                    <div>
                                        <a
                                    ...
                                    <div class="col">
                                        <a
                                            href="/movie/detail?movieNo=${ageGroupGenderRecommendVO.movieNo}">
                                            ${ageGroupGenderRecommendVO.movieName}
                                        </a>
                                    </div>
                                    <div class="col">
                                        <fmt:formatDate

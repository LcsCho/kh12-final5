...
<div class="container-fluid mt-5">
    <div class="row">
        <div class="col-md-8 offset-md-2 container-border shadow-lg bg-body-tertiary rounded">
                ...
                <div class="d-flex flex-row">
                    <div class="p-2 ms-1">
                        <c:choose>
                            ...
                            <c:otherwise>
                                <img src="${pageContext.request.contextPath}/image/${memberImage}"
                                    class="img-fluid rounded-circle member-image img-thumbnail"
                                    style="width:230px; height: 230px;">
                            </c:otherwise>
                        </c:choose>
                    ...
                    <div class="p-2 d-flex align-items-end">
                        <div class="me-2">
                            <label>
                                <input type="file" class="image-chooser" accept="image/*" style="display:none;">
                                <i class="fa-solid fa-camera blue fa-xl"></i>
                            </label>
                        </div>
                        <div class="">
            ...
            <div class="container mb-2">
                ...
                <div class="row">
                    <div class="col">
                        <fmt:formatDate value="${memberDto.memberJoin}" pattern="yyyy년 MM월 dd일" /> 가입
                    </div>
                </div>
            </div>
            ...
            <div class="container text-center">
                <div class="row align-items-center">
                    ...
                    <div class="col justify-content-between d-flex flex-column
                        ...
                        <div class="text-center center-section" style="font-size: 22px;">${ratingCount}</div>
                        <div class="text-center center-section" style="font-size: 22px;">평점</div>
                    </div>
                    <div class="col justify-content-between d-flex flex-column
                                align-items-center sub-border-side" style="background-color: #eedbdb ;">
                        <div class="text-center center-section" style="font-size: 22px;">${wishCount}</div>
            ...
            <div class="d-flex mb-1 mt-3">
                <div class="p-2 ms-3" style="font-size: 24px;">
                    오늘의 영화 추천이에요!
                </div>
            ...
            <div class="row p-3">
                <div class="col">
                    <div class="row">
                        <div class="col">
                            <img src="https://picsum.photos/215/300" class="img-fluid member-image img-thumbnail"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button type="button" class="btn-close close-logoutCon" data-dismiss="modal"
                    aria-label="Close"></button>
            </div>
            <div class="modal-body p-5" style="font-size:20px;">
                로그아웃 하시겠습니까?
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary close-logoutCon" data-dismiss="modal">취소</button>
